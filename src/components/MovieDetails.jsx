...
/*
    Componente q muestra los detalles de una peli y permite al usuario calificarla y agregar a su lista de "vistas"
...
export const MovieDetails = ({
    ...
    // Hook para obtener los detalles de la película
                    ...
                    <section>
                        <div className="rating">
                            {!isWatched ? (
                                ...
                                <p>
                                    Has calificado esta película con{" "}
                                    {watchedUserRating} ⭐
                                </p>
                            )}
                        </div>
